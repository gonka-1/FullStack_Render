package duoc.Evaluacion.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(EvaluacionNoEncontradoException.class)
    public ResponseEntity<ErrorResponse> manejarEvaluacionNoEncontrado(EvaluacionNoEncontradoException ex,
                                                                       HttpServletRequest request) {
